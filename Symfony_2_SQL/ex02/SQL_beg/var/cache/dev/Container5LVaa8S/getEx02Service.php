 ...
 */
class getEx02Service extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\ex02\Controller\ex02' shared autowired service.
     *
     * @return \App\ex02\Controller\ex02
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/ex02/Controller/ex02.php';

        $container->services['App\\ex02\\Controller\\ex02'] = $instance = new \App\ex02\Controller\ex02($container->getEnv('DATABASE_HOST'), $container->getEnv('DATABASE_PORT'), $container->getEnv('DATABASE_NAME'), $container->getEnv('DATABASE_USER'), $container->getEnv('DATABASE_PASSWORD'));
        ...
        ]))->withContext('App\\ex02\\Controller\\ex02', $container));
