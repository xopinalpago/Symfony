 ...
 */
class getEx01Service extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\ex01\Controller\ex01' shared autowired service.
     *
     * @return \App\ex01\Controller\ex01
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/ex01/Controller/ex01.php';

        $container->services['App\\ex01\\Controller\\ex01'] = $instance = new \App\ex01\Controller\ex01($container->getEnv('DATABASE_HOST'), $container->getEnv('DATABASE_PORT'), $container->getEnv('DATABASE_NAME'), $container->getEnv('DATABASE_USER'), $container->getEnv('DATABASE_PASSWORD'));
        ...
        ]))->withContext('App\\ex01\\Controller\\ex01', $container));
