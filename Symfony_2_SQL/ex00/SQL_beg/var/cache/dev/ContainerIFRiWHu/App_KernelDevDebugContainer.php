...
class App_KernelDevDebugContainer extends Container
{
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'host' => $container->getEnv('DATABASE_HOST'),
            'port' => $container->getEnv('DATABASE_PORT'),
            'dbname' => $container->getEnv('DATABASE_NAME'),
            'user' => $container->getEnv('DATABASE_USER'),
            'password' => $container->getEnv('DATABASE_PASSWORD'),
