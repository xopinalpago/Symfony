...
class getEx00Service extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\ex00\\Controller\\ex00'] = $instance = new \App\ex00\Controller\ex00($container->getEnv('DATABASE_HOST'), $container->getEnv('DATABASE_PORT'), $container->getEnv('DATABASE_NAME'), $container->getEnv('DATABASE_USER'), $container->getEnv('DATABASE_PASSWORD'));
        ...
        ]))->withContext('App\\ex00\\Controller\\ex00', $container));
